...
public class ChatUseCase implements ChatUseCasePort {
    ...
    public static final String SYSTEM_INSTRUCTION = """
        You are "SDD Architect", an expert Product Manager and Software Architect. 
    ...
    public ChatUseCase(AiProviderPort aiProviderPort) {
        this.aiProviderPort = aiProviderPort;
    }

    @Override
    public AiResponse processChat(List<Message> messages) {
